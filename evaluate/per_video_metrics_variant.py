...
VARIANT = sys.argv[1]  # e.g. "qk_av" or "qk_av_proj" or "full"
RUN_ROOT = f"/home/dingqy/Bench/IRASim/results/04/24/test_bridge_frame_ada_sc_int8_{VARIANT}-debug/checkpoints/0300000"
...
FLAT_TMP = f"/tmp/fid_flat_{VARIANT}"
...
for f in files:
    ...
    print(f"{VARIANT}/{key}: {results[key]}")
